    ...
    <>
      <Card className="relative p-5 bg-white/80 hover:shadow-md transition-shadow">
        <button
          ...
          className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-200"
        >
